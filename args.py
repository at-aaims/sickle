...
parser.add_argument('--shuffle', action='store_true', default=True, help='Shuffle data before training')
...
parser.add_argument('--test_frac', type=float, default=0.3, help='fraction of data to hold out for testing')
