...
def build_model(input_shape, output_shape, units1=2000, units2=8000, units3=2000, activation='elu', window=1, num_heads=8, num_layers=6, dim_feedforward=16, dropout=0.1):
    model = MLP_transformer(input_shape, output_shape, units1, units2, units3, activation, num_heads, num_layers, dim_feedforward, dropout)
    return model
...
def get_meta_model(input_shape):
    def meta_model(hp):
        ...
        return build_model(input_shape, output_shape, units1, units2, units3, activation, num_heads, num_layers, dim_feedforward, dropout)
    return meta_model
